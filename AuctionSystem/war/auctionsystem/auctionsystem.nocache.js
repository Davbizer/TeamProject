...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "auctionsystem" because\n';
  ...
  $wnd.__gwt_activeModules['auctionsystem'] = {
 ...
 * "/auctionsystem.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['auctionsystem'].superdevmode = true;

  var expectedSuffix = '/auctionsystem.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + auctionsystem + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:auctionsystem';
  var devModeSessionKey = '__gwtDevModeSession:auctionsystem';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/auctionsystem/auctionsystem.nocache.js';
  ...
  $wnd.__gwt_activeModules['auctionsystem'].canRedirect = true;
  $wnd.__gwt_activeModules['auctionsystem'].superdevmode = true;
  ...
  css = (moduleIdx == 1 ? css : '') +
    ".gwt-DevModeModule-" + moduleIdx + ".gwt-DevModeCompiling div:before{" +
      "content:'COMPILING auctionsystem';" +
      "font-size:24px;" +
      "color:#d2d9ee;" +
    "}";
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/auctionsystem?user.agent=' + ua + '&_callback=' + callback;
